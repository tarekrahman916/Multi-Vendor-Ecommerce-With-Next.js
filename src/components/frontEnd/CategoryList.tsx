...
export default function CategoryList({ category }: { category: any }) {
  return (
    <div className="bg-white border border-gray-300 rounded-lg   dark:bg-gray-800 dark:border-gray-700 overflow-hidden">
      <div className="bg-gray-100 dark:bg-slate-800 py-3 px-6 font-semibold border-gray-300 dark:border-gray-600 border-b text-gray-800 dark:text-slate-200 flex justify-between items-center">
