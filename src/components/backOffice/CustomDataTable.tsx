...
export default function CustomDataTable() {
  ...
  return (
    <div className="mt-8 ">
      ...
      <div className="relative sm:w-full w-screen  overflow-x-auto  shadow-md sm:rounded-lg p-8">
        ...
        >
          <span className="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4 md:mb-0 block w-full md:inline md:w-auto">
            Showing{" "}
              ...
              return (
                <li key={i}>
                  <button
                    ...
                    className={
                      currentPage == i + 1
                        ? "flex items-center justify-center px-3 h-10 leading-tight text-gray-50 bg-blue-600 border border-blue-300 hover:bg-blue-800 hover:text-gray-50 dark:bg-slate-300 dark:border-slate-200 dark:text-slate-900 dark:hover:bg-slate-300 dark:hover:slate-900"
